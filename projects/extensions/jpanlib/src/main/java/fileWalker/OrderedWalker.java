			...
			if (matcher.fileMatches(filePath))
				try{
					...
					try{
						...
						Files.write(Paths.get("/home/liux19/yizhidou/Dataset/common_record_collection/joern_extraction_error_record.txt"), record_path.getBytes(), StandardOpenOption.APPEND);
